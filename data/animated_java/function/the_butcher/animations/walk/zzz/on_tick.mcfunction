...
execute if score @s aj.walk.frame matches -1 run function animated_java:the_butcher/animations/walk/zzz/commands_keyframe_loop_patch
...
function animated_java:the_butcher/animations/walk/zzz/apply_frame with storage aj:temp args
