...
execute if score @s playerUI.Raycast matches ..0 run return run function player:zprivate/raycast/remove_ui

execute if block ~ ~ ~ #player:interactable run return run function player:zprivate/crosshair_icon/init
execute if entity @n[type=#player:interactable,dx=0] positioned ~-0.25 ~-0.25 ~-0.25 if entity @n[type=#player:interactable,dx=0] run return run function player:zprivate/crosshair_icon/init
