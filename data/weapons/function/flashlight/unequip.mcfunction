...
execute as @e[predicate=weapons:id,tag=hands_weapons.model,tag=aj.hands_tools_flashlight.root] run function animated_java:hands_tools_flashlight/remove/this
