#> Prevents Looping:
execute if score @s player_hazmat.ANIMATION_STATE matches 1 run return fail
...
# Was Walking:
execute as @s[tag=player_hazmat.walk.left_foot] if score #PREVIOUS_STATE player_hazmat.ANIMATION_STATE matches 2 as @n[tag=player_hazmat.model,predicate=player_hazmat:model/id] run function animated_java:player_hazmat/animations/walk_stop2/tween {to_frame: 1, duration: 3}
execute as @s[tag=player_hazmat.walk.right_foot] if score #PREVIOUS_STATE player_hazmat.ANIMATION_STATE matches 2 as @n[tag=player_hazmat.model,predicate=player_hazmat:model/id] run function animated_java:player_hazmat/animations/walk_stop/tween {to_frame: 1, duration: 3}
...
scoreboard players set @s player_hazmat.ANIMATION_STATE 1
